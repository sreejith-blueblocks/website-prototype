        ...
        >
          ...
          >
            <div className="flex-1 max-w-[478px]">
              ...
              <p className="text-[12px] text-justify">
                Our robust WEB/ GRAPHIC-DESIGN and WEB DEVELOPMENT skills and
                tools can completely customize interactive web solutions to
                Solution-based web applications. Easy to use Content Management
                System (CMS) to users willing to update websites on their own.
                The CMS is developed by us and is entirely customizable to
                client requirements. Ultra-modern responsive UX/ UI designs on
                both desktop & mobile devices for higher user engagement
              </p>
          ...
          >
            ...
            <div className="flex-1 z-[995] max-w-[478px]">
              ...
              <p className="text-[12px] text-justify">
                Our experience & technical expertise can create On-Demand, Web,
                Mobile ((iOS and Android) and Cloud applications that redefine
                your Business Possibilities. We can help you scale your business
                by designing your custom organizational IT Infrastructure.
              </p>
              <p className="my-2 font-bold">Learn more</p>
            </div>
          </section>
