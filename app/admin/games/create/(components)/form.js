...
const Form = ({ setRefreshGames, refereshGames }) => {
  ...
  return (
    <>
      <div className="w-full rounded-lg p-6 py-8 bg-[#fdfdfd] text-black relative">
        ...
        {loading && (
          <div className="absolute w-full h-full bg-[#ffffff6e] top-0 left-0 flex flex-row justify-center items-center">
